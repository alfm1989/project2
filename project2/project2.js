...
$(".navbar-li-default-link").on("click", function(){
    ...
    if ($(this).text()=='Data Analytics Bootcamp') {
        ...
        $("pre").text("This website was created by students of the Data Analytics Bootcamp 2019-2020 with the objective of showing some information about CVOID-19's behaviour.");}
